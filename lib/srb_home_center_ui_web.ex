defmodule SrbHomeCenterUiWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: SrbHomeCenterUiWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/srb_home_center_ui_web/templates",
        namespace: SrbHomeCenterUiWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {SrbHomeCenterUiWeb.LayoutView, "live.html"}
